...
<!--start of head-->
    <head>
        ...
        <link rel="shortcut icon" href="https://application.officecloud.com.au/assets/img/icon.png">
...
<!--start of body-->
    <body>
        <div id="wrap">
                ...
                <div class="navbar-inner">
                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav pull-right">
                            ...
                            <li><a href="index.php?module=home"><i class="icon-home icon-black"></i> <?php echo $this->lang->line('home'); ?></a></li>
                            <li><a href="index.php?module=calendar"><i class="icon-calendar icon-black"></i>  <?php echo $this->lang->line('calendar'); ?></a></li>
                            <?php if (UP_EVENTS) { ?>
                                <li class="dropdown dropdown-big"> <a class="dropdown-toggle" href="#" data-toggle="dropdown"> <i class="icon-list icon-black"></i> <?php echo $this->lang->line('upcoming_events'); ?> </a>
                                    <ul class="dropdown-menu">
                                <?php echo UP_EVENTS; ?>
                                    </ul>
                                </li>
                            ...
                            <?php if ($this->ion_auth->in_group(array('owner', 'admin'))) { ?>
                                                            <li id="eann"><a href="#myModal" role="button" data-toggle="modal"><i class="icon-edit icon-black"></i>  <?php echo $this->lang->line('edit_ann'); ?></a></li>
                            <?php } ?>
                            <?php
            ...
            <div id="col_1">
            <a class="hdate" style="margin-left:-7px;color:#555;"><?php echo date('l, j F Y'); ?></a>
                <div id="mainmanu">
<?php if ($this->ion_auth->in_group(array('owner', 'admin'))) { ?>
                        <ul class="menu nav nav-tabs nav-stacked">
                            <li class="dropdown"><a class="showSubMenus" href="#warehousemenu"><i class="icon-home icon-white"></i> <?php echo $this->lang->line('warehouses'); ?> <b class="caret"></b></a>
                                <ul class="nav nav-tabs nav-stacked sub-menu" id="warehousemenu">
                            ...
                            <li class="dropdown"><a class="showSubMenus" href="#categorymenu"><i class="icon-list icon-white"></i> <?php echo $this->lang->line('categories'); ?> <b class="caret"></b></a>
                                <ul class="nav nav-tabs nav-stacked sub-menu" id="categorymenu">
                            ...
                            <li class="dropdown"><a class="showSubMenus" href="#purchasesMenu"><i class="icon-tags icon-white"></i> <?php echo $this->lang->line('purchases'); ?> <b class="caret"></b></a>
                            ...
                            <li class="dropdown"><a class="showSubMenus" href="#salesMenu"><i class="icon-print  icon-white"></i> <?php echo $this->lang->line('sales'); ?> <b class="caret"></b></a>
