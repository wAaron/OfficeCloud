...
$(document).ready(function() {
	...
	*/
	...
	var opts = {
		...
		mapCenterLt: validateFloat('lat',-180,180, -37.843844),
		mapCenterLg: validateFloat('lng',-180,180, 144.981079), // default to Melbourne
...
*/
		...
		function mapJumpBox() {
			...
			info.innerHTML = '<form action="#" onsubmit="cnMFUI.jumpToAddress(this.address.value); return false">'
				+ '<input style="display:none;"id="jumpBox" type="text" size=27 name="address" value ="' + jumptxt
...
/*
  ...
  window.cnMFUI = {
	...
	defaults:  {
		...
		mapCenterLt: '-37.843844',
		mapCenterLg: '144.981079',
		mapZoom: 14,
		mapType: 0,
		mapAllOnInit: true,
